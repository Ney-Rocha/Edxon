...
13. **Fixação Exclusiva do Tema Claro (Light Mode):** Removida a alternância de tema e a versão dark da aplicação, estabelecendo a interface clara como padrão permanente e removendo os botões de alternância no cabeçalho e na tela de login.
